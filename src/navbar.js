export const navBar = () => {
  ...
  home.classList.add('nav-link'); // creating the class for a tag
  ...
  menu.classList.add('nav-link'); // creating the class for a tag
  ...
  contact.classList.add('nav-link'); // creating the class for a tag
